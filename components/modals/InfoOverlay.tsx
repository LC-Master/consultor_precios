...
export default function InfoOverlay() {
    return (
        <div className="absolute bottom-8 sm:bottom-10 left-0 right-0 z-20 flex justify-center pointer-events-none">
            <div className="relative bg-locatel-fuerte/98 backdrop-blur-md border-2 border-locatel-medio/60 px-6 py-4 sm:px-10 sm:py-5 md:px-14 md:py-6 rounded-[1.5rem] sm:rounded-[1.75rem] md:rounded-[2rem] shadow-2xl shadow-black/40 flex items-center gap-4 sm:gap-5 md:gap-6 transition-all duration-300 max-w-[95vw] sm:max-w-3xl mx-auto">
